...
import { showLoading, placeBet, hideBetModal } from "../actions";
        ...
        return ReactDOM.createPortal(
            <>
                <Transition visible={this.props.showBetModal} animation='fade' duration={400}>
                    <div onClick={this.state.hideBetModal} className="ui active dimmer" style={{position: 'fixed', width: '100%', height: '100%', zIndex: 999}}></div>
                </Transition>
...
export default connect(mapStateToProps, { showLoading, placeBet, hideBetModal })(Modal);